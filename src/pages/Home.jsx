        ...
        <div className="bg-secondary rounded-lg p-5">
          <div className="flex gap-3 mb-4">
            <img
              ...
              width="50"
              height="50"
              className="w-[3rem] object-contain grayscale"
              alt=""
            />
          ...
          <p className="desc !text-white">
            Achieve mobile excellence with powerful, custom-built apps for iOS &
            Android.
          </p>
        </div>
        ...
        <div className="bg-tertiary rounded-lg p-5">
          <div className="flex gap-3 mb-4">
            <img
              ...
              width="50"
              height="50"
              className="w-[3rem] object-contain brightness-0"
              alt=""
            />
            <p className="text-lg leading-tight font-medium">Web Development</p>
          </div>
          <p className="desc">
            Build fast, scalable, and secure web applications tailored to your
            business goals.
          </p>
        </div>
      </div>
